...
<div class="container">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:;"><img src="images/01.jpg" class="layui-nav-img">${sessionScope.ad.a_username}</a>
        ...
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a _href="${pageContext.request.contextPath}/findClassStudent">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>班级学生</cite>
                        </a>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/findDormitory">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>宿舍列表</cite>
                        </a>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/findDormitoryStudent">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>人员信息</cite>
                        </a>
...
<!-- 底部开始 -->
<div class="footer">
    <div class="copyright">Copyright ©2022-2025 版权所有</div>
</div>
<!-- 底部结束 -->
