...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.song.po.Student" %>
...
<div class="x-nav">
    ...
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${pageContext.request.contextPath}/findStudent" title="刷新">
...
<c:forEach items="${pi.list}" var="student">
        <tr>
            ...
            <td>
                <a title="编辑"    id= "updateEdit"    href="${pageContext.request.contextPath}/findStudentById?s_id=${student.s_id}">
