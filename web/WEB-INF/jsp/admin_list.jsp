...
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.song.po.Admin" %>
...
<div class="x-nav">
    ...
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${pageContext.request.contextPath}/findAdmin" title="刷新">
        ...
        form.on('submit(toolbarDemo)', function(){
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    // 2. 数组头部新增表头
                    dt.unshift({a_id: 'ID', a_username: '用户名', a_name: '姓名',a_password:'密码', a_phone: '电话', a_describe: '级别描述'});
