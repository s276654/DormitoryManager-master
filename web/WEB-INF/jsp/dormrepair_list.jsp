...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.song.po.DormRepair" %>
...
<div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="">首页</a>
        <a href="${pageContext.request.contextPath}/findDormRepair">维修信息</a>

      </span>
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${pageContext.request.contextPath}/findDormRepair" title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
</div>
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="${pageContext.request.contextPath}/findDormRepair" >
    ...
    <table class="layui-table">
        ...
        <c:forEach items="${di.list}" var="di">
            <tr>
                ...
                <td>
                    <a title="编辑"    id= "updateEdit"    href="${pageContext.request.contextPath}/findDormRepairById?r_id=${di.r_id}">
