...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.song.po.Dormitory" %>
...
<div class="x-nav">
    ...
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${pageContext.request.contextPath}/findDormitory" title="刷新">
...
<c:forEach items="${di.list}" var="di">
        <tr>
            ...
            <td>${di.a_name}</td>
            <td>
                <a title="编辑"    id= "updateEdit"    href="${pageContext.request.contextPath}/findDormitoryById?d_id=${di.d_id}">
